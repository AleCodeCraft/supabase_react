...
export const Button = memo(({ 
  ...
  const variants = {
    primary: "bg-gold-600 text-white hover:bg-gold-500",
    secondary: "bg-transparent text-gold-600 border-2 border-gold-600 hover:bg-gold-600 hover:text-dark-950",
    danger: "bg-transparent text-red-400 border-2 border-red-400 hover:bg-red-400 hover:text-dark-950",
    ghost: "bg-transparent text-gold-600 hover:bg-gold-600/10"
  }
